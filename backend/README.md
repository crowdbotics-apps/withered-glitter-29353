...
## Project Structure
    ...
    ├── withered_glitter_29353  # Django project configurations
...
1. Clone this repo and `cd withered_glitter_29353`
...
2. Clone this repo and `cd withered_glitter_29353`
